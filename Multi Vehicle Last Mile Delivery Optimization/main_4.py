# This file calculates the scenario for the two sub areas
# [START import]
from functools import partial
from ortools.constraint_solver import routing_enums_pb2
from ortools.constraint_solver import pywrapcp
from Node_double_depot import Area1Matrix, Area1TimeMatrix, Area2Matrix, Area2TimeMatrix
...
for EVrange in [80]:
    for EVnum in [12]:
        for num_vehicle in range(24, 30):
            ...
            # # Function call Area 1
            Main_function(Area1Matrix, Area1TimeMatrix, num_vehicle, vehicle_range, para.EV_cost_per_mile,
                          para.GV_cost_per_mile, num_ev)

            # Function call Area 2
            # Main_function(Area2Matrix, Area2TimeMatrix, num_vehicle, vehicle_range, para.EV_cost_per_mile,
            #               para.GV_cost_per_mile, num_ev)
